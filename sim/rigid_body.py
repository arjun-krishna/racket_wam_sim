...
class Sphere(RigidBody):
    ...
    def __init__(
        ...
        super().__init__(position, orientation, linear_momentum, angular_momentum, mass, fixed)
...
class HollowSphere(RigidBody):
    ...
    def __init__(
        ...
        self.inverse_inertia = np.eye(3) * (2.5 / mass) * ((radius_2**3 - radius_1**3) / (radius_2**5 - radius_1**5))
